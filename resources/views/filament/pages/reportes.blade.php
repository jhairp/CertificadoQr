<x-filament-panels::page>
    ...
    <x-filament::modal id="modal-reporte-simple" width="7xl">
        ...
        <div class="modal-layout">
            ...
            <div class="col-tabla">
                @php $certificadosPaginados = $this->getCertificadosQuery()->paginate(5); @endphp
                <table class="tabla-excel">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="6" style="padding: 2rem; text-align: center; color: gray; background-color: white;">No hay datos.</td></tr>
                        @endforelse
                    </tbody>
                </table>
                <div style="margin-top: 1rem;">{{ $certificadosPaginados->links() }}</div>
            </div>
        </div>
